// schemeInformationCentral.dart - Updated with Proper Navigation
import 'package:flutter/material.dart';
import 'schemeEligibilityIndividualCentral.dart';
import 'geminiAPI.dart';

class SchemeInformationCentralPage extends StatefulWidget {
  ...
  _SchemeInformationCentralPageState createState() =>
      _SchemeInformationCentralPageState();
}

class _SchemeInformationCentralPageState
    extends State<SchemeInformationCentralPage>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          widget.scheme['Title']?.toString() ?? 'Scheme Details',
          style: TextStyle(
              ...
              children: [
                Row(
                  children: [
                    Expanded(
                      child: Text(
                        widget.scheme['Title']?.toString() ?? 'Scheme',
                        style: TextStyle(
                ...
                SizedBox(height: 8),
                Text(
                  widget.scheme['Description']?.toString() ??
