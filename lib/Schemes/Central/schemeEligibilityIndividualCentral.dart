// schemeEligibilityIndividualCentral.dart - Central Schemes with Multilingual Support
...
class SchemeEligibilityIndividualCentral extends StatefulWidget {
  ...
  _SchemeEligibilityIndividualCentralState createState() =>
      _SchemeEligibilityIndividualCentralState();
}
...
class _SchemeEligibilityIndividualCentralState
  ...
  final Map<String, Map<String, String>> _uiTranslations = {
    'English': {
      ...
      'loadingQuestions': 'AI is generating personalized questions...',
      'analyzingCriteria': 'Analyzing eligibility criteria',
    },
    'Kannada': {
      ...
      'loadingQuestions': 'AI ವೈಯಕ್ತಿಕ ಪ್ರಶ್ನೆಗಳನ್ನು ರಚಿಸುತ್ತಿದೆ...',
      'analyzingCriteria': 'ಅರ್ಹತೆ ಮಾನದಂಡಗಳನ್ನು ವಿಶ್ಲೇಷಿಸಲಾಗುತ್ತಿದೆ',
    },
    'Hindi': {
      ...
      'loadingQuestions': 'AI व्यक्तिगत प्रश्न तैयार कर रहा है...',
      'analyzingCriteria': 'पात्रता मानदंडों का विश्लेषण',
    },
  };
  ...
  Future<void> _generateQuestions() async {
    ...
    try {
      ...
      final documents = _parseStringList(widget.scheme['Documents Required']);

      // Generate questions using Gemini AI
      final questions = await GeminiService.generateEligibilityQuestions(
        eligibility.isEmpty ? ['General eligibility check'] : eligibility,
        documents.isEmpty ? ['Basic documents'] : documents,
      );
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: Text(
                'Unable to generate eligibility questions. Please try again.',
                style: TextStyle(
                  color:
...
JSON response (ONLY):''';
  ...
  Widget _buildLoadingScreen(Color cardColor, Color textColor) {
    return Center(
      child: Container(
